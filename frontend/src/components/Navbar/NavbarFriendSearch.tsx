...
//import { API } from '/frontend/src/components/Navbar/NavbarFriendSearch/yaliesapi';
...
// Get data from Yalies TODO dont have this hardcoded but idk how to use JS env variables lol

const yalies_api = new API(
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2NzU3MjQ4MDUsInN1YiI6ImFuczYyIn0.uwYQXBdChMpVYPRbxQmDKKObj6wbD1q0fnc1W_Rqk6k'
);

function friendSearch(query: string) {
  return yalies_api.people({
    query: '"' + query + '"',
    filters: {
      school_code: ['YC'],
    },
 ...
 */
export const NavbarFriendSearch: React.FC = () => {
  ...
  //console.log('hi', searchTextInput.current);
            ...
            <InputGroup className="h-100">
              <NavbarStyledSearchBar
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                  ...
                  console.log('hi1', friendSearch(searchText));
                  setStartTime(Date.now());
                }}
                placeholder="Search for some friends to share in the joy of choosing classes!"
                ref={searchTextInput}
              />
            </InputGroup>
            {searchText && (
